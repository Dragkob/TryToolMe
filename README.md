...
| **Server status** | Live server status and downtime today (minutes) via the **ⓘ** control next to "Server status". Requests are rate-limited (at most about once per 30s) with local-only caching. | <p align="center"><img width="371" height="155" alt="image" src="https://github.com/user-attachments/assets/6b9bb192-683c-4d3a-b58a-bfaea3549303" /></p> |
